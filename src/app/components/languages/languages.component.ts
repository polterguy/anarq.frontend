...
export class LanguagesComponent implements OnInit {
  ...
  private displayedColumns: string[] = ['locale', 'description', 'delete-instance'];
  ...
  getData(countRecords: boolean = true) {
    ...
    this.httpService.languages_Get(this.filter).subscribe(res => {
      this.data = res;
      ...
      if (countRecords) {
        ...
        this.httpService.languages_count_Get(cloned).subscribe(res2 => {
  ...
  editDetails(entity: any) {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('Languages item successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('Languages item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  delete(entity: any, ids: any) {
    ...
    this.httpService.languages_Delete(ids).subscribe(res => {
