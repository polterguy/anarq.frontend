...
/*
 * Modal dialog for editing your existing Pgp_key_types entity types, and/or
 * creating new entity types.
 */
@Component({
  templateUrl: './edit.pgp_key_types.component.html',
  styleUrls: ['./edit.pgp_key_types.component.scss']
})
export class EditPgp_key_typesComponent {
