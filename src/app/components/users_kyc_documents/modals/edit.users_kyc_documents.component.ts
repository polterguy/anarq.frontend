...
/*
 * Modal dialog for editing your existing Users_kyc_documents entity types, and/or
 * creating new entity types.
 */
@Component({
  templateUrl: './edit.users_kyc_documents.component.html',
  styleUrls: ['./edit.users_kyc_documents.component.scss']
})
export class EditUsers_kyc_documentsComponent {
   ...
   */
  private createColumns: string[] = ['user', 'content'];
  private updateColumns: string[] = ['id', 'user', 'content'];
   ...
   */
  constructor(
    public dialogRef: MatDialogRef<EditUsers_kyc_documentsComponent>,
  ...
  save() {
    ...
    if (this.data.isEdit) {
      ...
      this.service.users_kyc_documents_Put(this.data.entity).subscribe(res => {
      ...
      this.service.users_kyc_documents_Post(this.data.entity).subscribe(res => {
        this.dialogRef.close(this.data.entity);
