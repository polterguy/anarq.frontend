...
/*
 * "Datagrid" component for displaying instance of Case_types
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-case_types',
  templateUrl: './case_types.component.html',
  styleUrls: ['./case_types.component.scss']
})
export class Case_typesComponent implements OnInit {
  ...
  displayedColumns: string[] = ['type', 'description', 'delete-instance'];
  ...
  editDetails(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditCase_typesComponent, {
      data
    });
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('Case_types item successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('Case_types item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
