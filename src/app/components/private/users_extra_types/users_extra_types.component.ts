 ...
 */
@Component({
  selector: 'app-users_extra_types',
  templateUrl: './users_extra_types.component.html',
  styleUrls: ['./users_extra_types.component.scss']
})
export class Users_extra_typesComponent implements OnInit {
  ...
  displayedColumns: string[] = ['type', 'description', 'mandatory', 'delete-instance'];
  ...
  editDetails(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditUsers_extra_typesComponent, {
      data
    });
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('Users_extra_types item successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('Users_extra_types item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
