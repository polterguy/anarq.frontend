...
/*
 * Modal dialog for editing your existing Users_extra_types entity types, and/or
 * creating new entity types.
 */
@Component({
  templateUrl: './edit.users_extra_types.component.html',
  styleUrls: ['./edit.users_extra_types.component.scss']
})
export class EditUsers_extra_typesComponent {
   ...
   */
  constructor(
    public dialogRef: MatDialogRef<EditUsers_extra_typesComponent>,
