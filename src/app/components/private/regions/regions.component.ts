...
export class RegionsComponent implements OnInit {
  ...
  private displayedColumns: string[] = ['region', 'description', 'delete-instance'];
  ...
  editDetails(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditRegionsComponent, {
      data
    });
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('Regions item successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('Regions item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
