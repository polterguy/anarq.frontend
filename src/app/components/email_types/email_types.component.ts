 ...
 */
@Component({
  selector: 'app-email_types',
  templateUrl: './email_types.component.html',
  styleUrls: ['./email_types.component.scss']
})
export class Email_typesComponent implements OnInit {
  ...
  getData(countRecords: boolean = true) {
    ...
    this.httpService.email_types_Get(this.filter).subscribe(res => {
      this.data = res;
      ...
      if (countRecords) {
        ...
        this.httpService.email_types_count_Get(cloned).subscribe(res2 => {
  ...
  editDetails(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditEmail_typesComponent, {
      data
    });
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('Email_types item successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('Email_types item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  delete(entity: any, ids: any) {
    ...
    this.httpService.email_types_Delete(ids).subscribe(res => {
