...
/*
 * Modal dialog for editing your existing Email_types entity types, and/or
 * creating new entity types.
 */
@Component({
  templateUrl: './edit.email_types.component.html',
  styleUrls: ['./edit.email_types.component.scss']
})
export class EditEmail_typesComponent {
   ...
   */
  private createColumns: string[] = ['type', 'description'];
  private updateColumns: string[] = ['type', 'description'];
  private primaryKeys: string[] = ['type'];

  /*
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditEmail_typesComponent>,
  ...
  save() {
    ...
    if (this.data.isEdit) {
      ...
      this.service.email_types_Put(this.data.entity).subscribe(res => {
      ...
      this.service.email_types_Post(this.data.entity).subscribe(res => {
        this.dialogRef.close(this.data.entity);
