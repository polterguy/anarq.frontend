 ...
 */
@Component({
  selector: 'app-users_extra',
  templateUrl: './users_extra.component.html',
  styleUrls: ['./users_extra.component.scss']
})
export class Users_extraComponent implements OnInit {
  ...
  private displayedColumns: string[] = ['user', 'type', 'value', 'delete-instance'];
  ...
  editDetails(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditUsers_extraComponent, {
      data
    });
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.snackBar.open('Users_extra item successfully updated', 'Close', {
          duration: 2000,
        });
      }
    });
  ...
  createNewRecord() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res !== null && res !== undefined) {
        ...
        this.getData();
        this.snackBar.open('Users_extra item successfully created', 'Close', {
          duration: 2000,
        });
      }
    });
