...
/*
 * Modal dialog for editing your existing Users_extra entity types, and/or
 * creating new entity types.
 */
@Component({
  templateUrl: './edit.users_extra.component.html',
  styleUrls: ['./edit.users_extra.component.scss']
})
export class EditUsers_extraComponent {
   ...
   */
  private createColumns: string[] = ['user', 'type', 'value'];
  private updateColumns: string[] = ['user', 'type', 'value'];
  private primaryKeys: string[] = ['user', 'type'];

  /*
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditUsers_extraComponent>,
  ...
  save() {
    ...
    if (this.data.isEdit) {
      ...
      this.service.users_extra_Put(this.data.entity).subscribe(res => {
      ...
      this.service.users_extra_Post(this.data.entity).subscribe(res => {
        this.dialogRef.close(this.data.entity);
