...
@Component({
  ...
  styleUrls: ['./edit.emails.component.scss']
})
export class EditEmailsComponent {
   ...
   */
  private createColumns: string[] = ['type', 'signature', 'content'];
  private updateColumns: string[] = ['id', 'type', 'signature', 'content'];
   ...
   */
  constructor(
    public dialogRef: MatDialogRef<EditEmailsComponent>,
