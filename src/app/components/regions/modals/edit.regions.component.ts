...
/*
 * Modal dialog for editing your existing Regions entity types, and/or
...
export class EditRegionsComponent {
   ...
   */
  private createColumns: string[] = ['region', 'description'];
  private updateColumns: string[] = ['region', 'description'];
  private primaryKeys: string[] = ['region'];

  /*
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditRegionsComponent>,
