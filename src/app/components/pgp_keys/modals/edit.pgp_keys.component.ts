...
/*
 * Modal dialog for editing your existing Pgp_keys entity types, and/or
 * creating new entity types.
 */
@Component({
  templateUrl: './edit.pgp_keys.component.html',
  styleUrls: ['./edit.pgp_keys.component.scss']
})
export class EditPgp_keysComponent {
   ...
   */
  private createColumns: string[] = ['user', 'key_id', 'type', 'fingerprint', 'created', 'expires', 'strength', 'content'];
  private updateColumns: string[] = ['id', 'user', 'key_id', 'type', 'fingerprint', 'created', 'expires', 'strength', 'content'];
   ...
   */
  constructor(
    public dialogRef: MatDialogRef<EditPgp_keysComponent>,
