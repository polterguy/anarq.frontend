 ...
 */
@Component({
  templateUrl: './edit.case_types.component.html',
  styleUrls: ['./edit.case_types.component.scss']
})
export class EditCase_typesComponent {
   ...
   */
  constructor(
    public dialogRef: MatDialogRef<EditCase_typesComponent>,
  ...
  save() {
    ...
    if (this.data.isEdit) {
      ...
      this.service.case_types_Put(this.data.entity).subscribe(res => {
      ...
      this.service.case_types_Post(this.data.entity).subscribe(res => {
        this.dialogRef.close(this.data.entity);
